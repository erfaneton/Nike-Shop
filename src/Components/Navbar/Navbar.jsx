...
export default function NavBar() {
    ...
    return (
        <Navbar expand="lg" className="bg-transparent" style={{zIndex: '10000'}}>
            <Container fluid>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <div className="d-flex ">
                        ...
                        <Button className="bg-transparent d-flex justify-content-center align-items-center rounded-circle p-2 border-0">
